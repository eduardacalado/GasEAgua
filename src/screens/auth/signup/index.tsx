...
export function SignUp() {
  ...
  async function handlePressHome(data: yup.InferType<typeof schema>) {
    ...
    setIsLoading(true);
    try {
      await postSignup({username, email, password, telephone: phonenumber, address})
    ...
    <LinearGradientBackground>
      ...
      <S.SafeAreaViewContainer>
        ...
        <S.Container>
          ...
          />
          {errors.username && <S.LabelError>{errors.username?.message}</S.LabelError>}
          ...
          />
          {errors.address?.local && <S.LabelError>{errors.address?.local?.message}</S.LabelError>}
          ...
          />
          {errors.address?.street && <S.LabelError>{errors.address?.street?.message}</S.LabelError>}
          ...
          />
          {errors.address?.number && <S.LabelError>{errors.address?.number?.message}</S.LabelError>}
          ...
          />
          {errors.address?.reference && <S.LabelError>{errors.address?.reference?.message}</S.LabelError>}
          ...
          />
          {errors.phonenumber && <S.LabelError>{errors.phonenumber?.message}</S.LabelError>}
          ...
          <TouchableOpacity onPress={handleSubmit(handlePressHome)} disabled={isLoading}>
            <S.SignUpButton
